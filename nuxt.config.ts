...
export default defineNuxtConfig({
  ...
  sitemap: {
    ...
    urls: [
      ...
      '/avocat-morges',
      '/avocat-renens',
      '/auteur/mansour-cheema',
      '/glossaire',
      '/glossaire/ordonnance-penale-geneve',
      '/glossaire/mpuc-geneve',
      '/glossaire/assistance-judiciaire-geneve',
      '/glossaire/ocpm-geneve',
      '/glossaire/prud-hommes-geneve',
      '/cas-clients',
      '/mentions-legales',
      '/confidentialite',
      '/droit-penal',
      '/droit-penal-lausanne',
      '/droit-affaires',
      '/droit-administratif',
      '/droit-assurance',
      '/droit-famille',
      '/droit-famille/avocat-divorce',
      '/droit-famille/avocat-divorce-lausanne',
      '/droit-famille/avocat-pension-alimentaire',
      '/droit-famille/avocat-separation',
      '/droit-famille/avocat-garde-enfant',
      '/droit-famille/avocat-succession',
      '/droit-travail',
      '/droit-travail/avocat-licenciement',
      '/droit-etrangers',
